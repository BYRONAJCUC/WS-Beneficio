...
//            return new ResponseEntity(new Mensaje("ese dpi ya existe"), HttpStatus.BAD_REQUEST);
        Parcialidad parcialidad = new Parcialidad(parcialidadDto.getCuenta(), parcialidadDto.getNoParcialidad(), parcialidadDto.getPesoTotal(),parcialidadDto.getFechaRecibido(),parcialidadDto.getUsuarioCreacion());
        
        parcialidadService.save(parcialidad);
        return new ResponseEntity(new Mensaje("Parcialidad Registrada"), HttpStatus.OK);
    }
}
