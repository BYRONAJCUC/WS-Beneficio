...
public class TransporteService {
    ...
    public Optional<Transporte> getByUsuarioCreacion(String usuario){
        return transporteRepository.findByUsuarioCreacion(usuario);
    }
    ...
    public boolean existsByPlaca(String placa){
        return transporteRepository.existsByPlaca(placa);
    }
}
